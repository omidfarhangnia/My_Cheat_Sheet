...
// دومین نکته ما با دستورات سیدی میتوانیم در فایل های حرکت کنیم اما وقتی ما ترمینالی برای فایل پدر داریم وقتی یک بار فایل فرزند را تغییر دادم اول در خود فایل فرزند باید اد و کامیت صورت بگیرد و در مرحله دوم باید در فایل پدر هم اد و کامیت صورت بگیرد
// نکته سوم به مکان هایی که ما میتوانیم کد ها را از آن کلون کنیم و بعد به آن مکان ها پوش کنیم ریموت گفته میشود
// زمانی که دو نفر در یک قسمت از پروژه از با ابزار های متفاوت تغییری ایجاد میکنند به اصطلاح ما در آن مکان دچار کانفلیکت میشویم
// conflict  
